...
- **No instrumented tests currently** — project verification primarily uses JVM unit tests plus APK build/device smoke checks
- **`org.json:json:20231013`** dependency for JVM `JSONObject` support
